	...
	const sidebarProps: ChatSpacesSidebarProps = useMemo(
		() => ({
			...
			onHardPurgeAllMessages: () =>
				void membersModel.handleHardPurgeAllMessages(),
			hardPurgeFeedback: membersModel.hardPurgeFeedback,
		...
		[
			...
			membersModel.hardPurgeFeedback,
			...
			membersModel.handleHardPurgeAllMessages,
			newSpaceName,
			setNewSpaceName,
			createSpace,
			spaces,
