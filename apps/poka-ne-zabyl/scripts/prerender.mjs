							...
							mainEntity: [
								{
									...
									acceptedAnswer: {
										"@type": "Answer",
										text: "Нет. Приложение открывается в обычном браузере и добавляется на главный экран телефона без магазина приложений. После установки оно запускается отдельно. Telegram-бот остаётся быстрым способом записывать расходы.",
									},
								},
								{
									"@type": "Question",
