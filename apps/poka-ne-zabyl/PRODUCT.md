...
Warm, attentive, quietly effective.

## Anti-references

Generic fintech, corporate SaaS, childish mascots, scrapbook nostalgia, and payment-led marketing before payments launch.

## Design Principles

- Show the capture-to-confirmation action instead of describing technology.
- Make mobile the primary composition, not a reduced desktop page.
...
Readable Russian copy, visible focus states, 44px touch targets, sufficient contrast, and reduced-motion support.
