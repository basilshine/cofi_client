export const PUBLIC_PAGE_SEO = [
	{
		path: "/",
		title: "Пока не забыл — учёт расходов в Telegram",
		description:
			"Записывайте личные и общие расходы в Telegram текстом, голосом или фотографией чека. Проверяйте суммы, категории и лимиты в Mini App.",
	},
	{
		path: "/offer",
