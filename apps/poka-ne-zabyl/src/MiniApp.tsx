...
const previewCategories: Category[] = [
	...
	},
	{
		...
		total: 540,
		month_spent: 280,
		last_used: new Date(Date.now() - 432000000).toISOString(),
		is_system: true,
		can_edit: true,
		can_delete: true,
	},
...
export const MiniApp = ({
	...
	const categoryOverview = useMemo(() => {
		...
		return {
			all: homeCategoryRows(rows, Number.MAX_SAFE_INTEGER),
...
const Overview = ({
	...
	const categoryDistribution = homeCategoryDistribution(allCategories, total);
	const categoryRemainder = homeCategoryRemainder(
		allCategories,
		categories,
		total,
	);
