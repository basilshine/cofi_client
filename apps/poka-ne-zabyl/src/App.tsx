				...
				<div className="shell" data-reveal>
					...
					<div className="pricing-plans">
						<article className="pricing-plan">
							...
							<ul>
								<li>
									<Check size={18} weight="bold" /> 50 приветственных разборов
									один раз
								</li>
								<li>
						...
						<article className="pricing-plan pricing-plan--plus">
							...
							<ul>
								<li>
									<Check size={18} weight="bold" /> 250 разборов на оплаченный
									период
								</li>
								<li>
					...
					<div className="pack-pricing">
						...
						<div className="pack-pricing__list" aria-label="Стоимость пакетов">
							...
							<div>
								<strong>250</strong>
								<span>199 ₽ на Базовом</span>
								<b>159 ₽ с Плюс</b>
							</div>
							<div>
								<strong>500</strong>
								<span>349 ₽ на Базовом</span>
								<b>279 ₽ с Плюс</b>
							</div>
						</div>
					</div>
	...
	return (
		<LegalPage title="Публичная оферта">
			...
			<p>
				...
				приветственный набор из 50 разборов, 15 стандартных и до 3
			...
			<p>
				...
				активации и включает 250 разборов на оплаченный период, до 100
			...
			<p>
				Дополнительные пакеты содержат 50, 100, 250 или 500 разборов. Для тарифа
				«Базовый» они стоят 59, 99, 199 и 349 рублей, для тарифа «Плюс» — 49,
				79, 159 и 279 рублей соответственно. Покупка пакета увеличивает только
				запас разборов и не меняет текущий тариф или дату его обновления.
			</p>
			<p>
