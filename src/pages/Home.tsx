import { ChartLineUp, Wallet, ChartPie } from '@phosphor-icons/react';
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Welcome to Cofilance</h1>
        <p className="text-muted-foreground">
          Your personal financial management assistant. Track expenses, analyze spending patterns, and
