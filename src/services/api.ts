...
const ENDPOINTS = {
  ...
  expenseById: (id: number | string) => `/api/v1/finances/expenses/${id}` as const,
  ...
  expensesMostUsedCategories: "/api/v1/finances/expenses/most-used-categories" as const,
  expensesMostUsedTags: "/api/v1/finances/expenses/most-used-tags" as const,
  categories: "/api/v1/finances/categories" as const,
  categoryById: (id: number | string) => `/api/v1/finances/categories/${id}` as const,
  recurring: "/api/v1/finances/recurring" as const,
  recurringById: (id: number | string) => `/api/v1/finances/recurring/${id}` as const,
  ...
  reminderById: (id: number | string) => `/api/v1/notify/reminders/${id}` as const,
  notifications: "/api/v1/notify/notifications" as const,
  notificationById: (id: number | string) => `/api/v1/notify/notifications/${id}` as const,
};
...
export const apiService = {
  auth: {
    ...
    passwordResetConfirm: (data: components["schemas"]["ResetPasswordConfirmRequest"]) =>
      api.post<
  ...
  expenses: {
    ...
    update: (id: number | string, data: Partial<components["schemas"]["Expense"]>) =>
      api.put<components["schemas"]["Expense"]>(ENDPOINTS.expenseById(id), data),
    delete: (id: number | string) =>
      api.delete(ENDPOINTS.expenseById(id)),
    summary: () =>
      api.get<components["schemas"]["ExpenseSummary"]>(ENDPOINTS.expensesSummary),
    ...
    createFromVoice: (formData: FormData) =>
      api.post<components["schemas"]["Expense"]>(ENDPOINTS.expensesVoice, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    tags: (params?: { language?: string }) =>
      api.get<components["schemas"]["Tag"][]>(ENDPOINTS.expensesTags, { params }),
    mostUsedCategories: () =>
      api.get<components["schemas"]["Category"][]>(ENDPOINTS.expensesMostUsedCategories),
    mostUsedTags: () =>
      api.get<components["schemas"]["Tag"][]>(ENDPOINTS.expensesMostUsedTags),
  },
  categories: {
    list: () => api.get<components["schemas"]["Category"][]>(ENDPOINTS.categories),
    ...
    update: (id: number | string, data: Partial<components["schemas"]["Category"]>) =>
      api.put<components["schemas"]["Category"]>(ENDPOINTS.categoryById(id), data),
    delete: (id: number | string) =>
      api.delete(ENDPOINTS.categoryById(id)),
  },
  recurring: {
    list: () => api.get<components["schemas"]["RecurringExpense"][]>(ENDPOINTS.recurring),
    create: (data: components["schemas"]["RecurringExpense"]) =>
      api.post<components["schemas"]["RecurringExpense"]>(ENDPOINTS.recurring, data),
    getById: (id: number | string) =>
      api.get<components["schemas"]["RecurringExpense"]>(ENDPOINTS.recurringById(id)),
    update: (id: number | string, data: Partial<components["schemas"]["RecurringExpense"]>) =>
      api.put<components["schemas"]["RecurringExpense"]>(ENDPOINTS.recurringById(id), data),
    delete: (id: number | string) =>
      api.delete(ENDPOINTS.recurringById(id)),
  },
  analytics: {
    summary: (user_id: number) =>
      api.get<components["schemas"]["AnalyticsSummary"]>(ENDPOINTS.analyticsSummary, { params: { user_id } }),
    week: (user_id: number) =>
      api.get<components["schemas"]["AnalyticsSummary"]>(ENDPOINTS.analyticsWeek, { params: { user_id } }),
    month: (user_id: number) =>
      api.get<components["schemas"]["AnalyticsSummary"]>(ENDPOINTS.analyticsMonth, { params: { user_id } }),
    emotions: (user_id: number) =>
      api.get<{ emotions?: Record<string, unknown>; most_common?: string; regret_amount?: number }>(ENDPOINTS.analyticsEmotions, { params: { user_id } }),
    reports: () =>
      api.get<components["schemas"]["ReportSchedule"][]>(ENDPOINTS.analyticsReports),
    createReport: (data: components["schemas"]["ReportSchedule"]) =>
      api.post<components["schemas"]["ReportSchedule"]>(ENDPOINTS.analyticsReports, data),
    scheduleReport: (data: components["schemas"]["ReportSchedule"]) =>
      api.post<components["schemas"]["ReportSchedule"]>(ENDPOINTS.analyticsReportsSchedule, data),
  },
  reminders: {
    list: () => api.get<components["schemas"]["Reminder"][]>(ENDPOINTS.reminders),
    ...
    update: (id: number | string, data: Partial<components["schemas"]["Reminder"]>) =>
      api.put<components["schemas"]["Reminder"]>(ENDPOINTS.reminderById(id), data),
    delete: (id: number | string) =>
      api.delete(ENDPOINTS.reminderById(id)),
  },
  notifications: {
    list: () => api.get<components["schemas"]["Notification"][]>(ENDPOINTS.notifications),
    create: (data: components["schemas"]["Notification"]) =>
      api.post<components["schemas"]["Notification"]>(ENDPOINTS.notifications, data),
    getById: (id: number | string) =>
      api.get<components["schemas"]["Notification"]>(ENDPOINTS.notificationById(id)),
    update: (id: number | string, data: Partial<components["schemas"]["Notification"]>) =>
      api.put<components["schemas"]["Notification"]>(ENDPOINTS.notificationById(id), data),
    delete: (id: number | string) =>
      api.delete(ENDPOINTS.notificationById(id)),
  },
};
