...
export interface paths {
    ...
    "/api/v1/auth/phone/link/request": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Start linking a phone to the current account
         * @description Returns a number that the authenticated user must call from the submitted phone.
         */
        post: {
            parameters: {
                query?: never;
            ...
            responses: {
                ...
                /** @description Phone is already linked to another account */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/auth/phone/link/status": {
        ...
        get?: never;
        put?: never;
        /** Check phone linking call status */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/auth/phone/link/confirm": {
        ...
        get?: never;
        put?: never;
        /** Confirm and link a phone to the current account */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/auth/profile/avatar": {
        ...
        /** Remove current user custom avatar */
        delete: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/me/push/config": {
        ...
        get: {
            ...
            requestBody?: never;
            responses: {
                /** @description Public VAPID configuration and feature availability */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/me/push/test": {
        ...
        post: {
            ...
            requestBody?: never;
            responses: {
                /** @description Test notification accepted by a push provider */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description No device is subscribed */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description Push provider rejected the notification */
                502: {
                    headers: {
                        [name: string]: unknown;
                    };
